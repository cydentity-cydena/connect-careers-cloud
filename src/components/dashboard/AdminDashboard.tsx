...
import { Shield, Users, Briefcase, AlertCircle, UserCog, CheckCircle, Bug, Settings, FolderKanban, FileCheck, BarChart3, Plus, Brain, Send, Flag, Youtube, Users2, CreditCard, GraduationCap } from "lucide-react";
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card 
            className="border-border shadow-card hover:shadow-lg transition-all cursor-pointer group"
            onClick={() => navigate('/admin/assessment-review')}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2 group-hover:text-primary transition-colors">
              ...
              <CardDescription>
                Review flagged assessments for AI-generated content
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
          ...
          >
            <CardHeader>
              ...
              <CardDescription>
                Create job postings on behalf of employers or recruiters
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
          ...
          <Card 
            className="border-border shadow-card hover:shadow-lg transition-all cursor-pointer group"
            onClick={() => navigate('/admin/partner-communities')}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2 group-hover:text-primary transition-colors">
              ...
              <CardDescription>
                Manage Discord and cybersecurity communities displayed on Community page
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
          ...
          <Card 
            className="border-border shadow-card hover:shadow-lg transition-all cursor-pointer group"
            onClick={() => navigate('/admin/subscription-overrides')}
          >
            <CardHeader>
              <CardTitle className="flex items-center gap-2 group-hover:text-primary transition-colors">
              ...
              <CardDescription>
                Grant free subscription access to employers and recruiters
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground transition-colors">

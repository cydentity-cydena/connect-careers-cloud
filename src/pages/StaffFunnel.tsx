...
const STAGES: Stage[] = [
  ...
  { name: "verified", position: 3, color: "bg-green-500/20" },
  { name: "published", position: 4, color: "bg-purple-500/20" },
  { name: "needs_info", position: 5, color: "bg-yellow-500/20" },
];
          ...
          {STAGES.map((stage) => {
            ...
            return (
              <Card key={stage.name} className="p-4">
                <div className="text-sm text-muted-foreground capitalize">{stage.name}</div>

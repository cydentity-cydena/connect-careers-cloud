-- Drop and recreate the award_points function to only award XP
-- All points now become XP (no more spendable points system)

DROP FUNCTION IF EXISTS award_points(UUID, TEXT, JSONB);

-- Fix the verify_ctf_flag function to use correct parameter name
...
BEGIN
  ...
  -- Case-sensitive comparison (use p_submitted_flag, not v_submitted_flag)
  v_is_correct := (p_submitted_flag = v_correct_flag);
